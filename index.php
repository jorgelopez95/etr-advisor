...
<body>
    ...
    <nav class="navbar navbar-inverse navbar-static-top">
        <div class="container">
            ...
            <div class="row">
              ...
              <!-- App text -->
              <div class="navbar-header col-md-5 col-sm-8">
              ...
              <!-- Buttons -->
              <div id="navbarMain" class="navbar-collapse collapse col-md-5 col-sm-2">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <a href="#" class="btn btn-success btn-lg" style="margin-left: 40%; margin-top: 20px">Subir archivo</a>
                    </div>
                </div>
            </div>  
        </div>
    ...
    <div class="container marketing" style="margin: 0px; padding: 0px">
        ...
        <div class="col-md-7">
            <h2 class="featurette-heading" style="margin-top: 15px; padding-left: 35px">Metodología</h2><br>
      ...
      <div class="row featurette">         
          <div class="row">
              <div class="col-md-12">
                  <h2 class="featurette-heading" id="pautas" style="margin-top: 0px;margin-bottom: 20px; text-align: center;">Pautas</h2> 
              </div>
          </div>
          <div class="col-md-6">
              ...
              <div class="panel panel-primary" style="margin: 20px 20px 0px 20px">
                  <div class="panel-heading" style="text-align: center; font-size: 20px">MAQUETACIÓN</div>
                  <table class="table table-hover">
                      <thead>
                          <tr>
                              <th>Pauta</th>
                              <th>Puntuación (100 puntos)</th>
                          </tr>
                      </thead>
                      <tbody>
                          <tr>
          ...
          <div class="col-md-6"> 
              <div class="panel panel-primary" style="margin: 20px 20px 0px 20px">
                  <div class="panel-heading" style="text-align: center; font-size: 20px">TEXTO</div>
                  <table class="table table-hover">
                      <thead>
                          <tr>
                              <th>Pauta</th>
        ...
        <div class="row">
            ...
            <div class="col-md-5">
                ...
                <form>
                    ...
                    <button class="btn btn-default" type="submit" name="button">Submit
                    </button>
                </form>
            </div>
        </div>
    ...
    <!-- Footer -->    
    <footer style="margin: 35px 0px 15px 15px; font-weight: bolder">
